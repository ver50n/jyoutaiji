            ...
            <div class="card-body">
              <div class="form-group">
                ...
                @foreach(App\Helpers\ApplicationConstant::SCHEDULE_TYPE as $key => $value)
                  <option value="{{$key}}" {{ $value == old('type') ? 'selected' : '' }}>
                    @lang('application-constant.SCHEDULE_TYPE.'.$value)
                  </option>
                @endforeach
                </select>
              </div>
              <div class="form-group">
                ...
                @foreach(App\Helpers\ApplicationConstant::SCHEDULE_CATEGORY as $key => $value)
                  <option value="{{$key}}" {{ $value == old('category') ? 'selected' : '' }}>
              ...
              <div class="form-group">
                <label>@lang('common.cost')</label> <span class="e_required">*</span>
                <input class="form-control input-sm"
                  name="cost"
                  value="{{old('cost')}}"
              ...
              <div class="form-group">
                <label>@lang('common.participant_limit')</label> <span class="e_required">*</span>
                <input class="form-control input-sm"
              ...
              <div class="form-group">
                ...
                @php
                  $oldValue = old('is_for_member_only') ? old('is_for_member_only') : 0;
                @endphp
              ...
              <div class="form-group">
                ...
                @php
                  $oldValue = old('is_auto_approve') ? old('is_auto_approve') : 0;
                @endphp
          ...
          <div id="collapse-view__additional-info" class="collapse show">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control input-sm"
                  name="location"
                  placeholder="@lang('common.location')">{{old('location')}}</textarea>
